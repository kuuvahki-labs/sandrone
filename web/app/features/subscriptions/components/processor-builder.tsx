...
export function ProcessorBuilder({ actionsContainer, defaultValue = [], onDirty, onValueChange, probeCacheTTLSeconds, probeDefaults, remoteDefaults = emptyRemoteDefaults, scriptFiles = [], scriptTimeoutMS }: { actionsContainer?: HTMLElement | null; defaultValue?: ProcessorDetail[]; onDirty?: () => void; onValueChange?: (value: ProcessorDetail[]) => void; probeCacheTTLSeconds: number; probeDefaults: ProbeDefaultsInput; remoteDefaults?: RemoteInputDefaults; scriptFiles?: ResourceOption[]; scriptTimeoutMS?: number }) {
  const { t } = useI18n();
