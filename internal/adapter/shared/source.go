...
const (
	MihomoModule  = "github.com/metacubex/mihomo@v1.19.30"
	SingBoxModule = "github.com/sagernet/sing-box@v1.14.0"
)
...
func SourceRefs(format string) []domain.SourceRef {
	...
	case "mihomo", "mihomo-proxies", "shadowrocket-proxies":
		return []domain.SourceRef{{
			...
			Lines:    "39-90",
			Note:     "proxy tags for Hysteria2, Realm and TLS identity fields",
		}, {
			Kind:     "implementation",
	...
	case "sing-box", "sing-box-outbounds":
		return []domain.SourceRef{{
			...
			Lines:    "22-83, 202-219",
			Note:     "JSON tags for Hysteria2 Realm, Gecko obfuscation and outbound fields",
		}, {
			Kind:     "implementation",
...
var adapterSourceRefs = map[string]map[domain.NodeType]domain.SourceRef{
	"mihomo": {
		...
		domain.NodeTypeHysteria2:    mihomoRef("mihomo hysteria2 outbound schema", "/adapter/outbound/hysteria2.go", "39-90", "proxy tags for Hysteria2, Realm and TLS identity fields"),
	...
	"sing-box": {
		...
		domain.NodeTypeHysteria2:   singBoxRef("sing-box hysteria2 outbound schema", "/option/hysteria2.go", "22-83, 202-219", "JSON tags for Hysteria2 Realm, Gecko obfuscation and outbound fields"),
