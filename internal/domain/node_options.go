...
type TLSOptions struct {
	...
	InsecureSkipVerify bool            `json:"insecure_skip_verify,omitzero" yaml:"insecure_skip_verify,omitempty"`
	...
	DisableSNI         bool            `json:"disable_sni,omitzero" yaml:"disable_sni,omitempty"`
	ECH                *ECHOptions     `json:"ech,omitzero" yaml:"ech,omitempty"`
	Reality            *RealityOptions `json:"reality,omitzero" yaml:"reality,omitempty"`
}

type DialerOptions struct {
	Network  string `json:"network,omitempty" yaml:"network,omitempty"`
	TFO      bool   `json:"tfo,omitzero" yaml:"tfo,omitempty"`
	UDPRelay *bool  `json:"udp_relay,omitzero" yaml:"udp_relay,omitempty"`
}
...
type TransportOptions struct {
	...
	MaxEarlyData             int                    `json:"max_early_data,omitzero" yaml:"max_early_data,omitempty"`
	EarlyDataHeaderName      string                 `json:"early_data_header_name,omitempty" yaml:"early_data_header_name,omitempty"`
	V2RayHTTPUpgrade         bool                   `json:"v2ray_http_upgrade,omitzero" yaml:"v2ray_http_upgrade,omitempty"`
	V2RayHTTPUpgradeFastOpen bool                   `json:"v2ray_http_upgrade_fast_open,omitzero" yaml:"v2ray_http_upgrade_fast_open,omitempty"`
	XHTTP                    *XHTTPTransportOptions `json:"xhttp,omitzero" yaml:"xhttp,omitempty"`
}

type XHTTPTransportOptions struct {
	Mode             string                 `json:"mode,omitempty" yaml:"mode,omitempty"`
	ReuseSettings    *XHTTPReuseSettings    `json:"reuse_settings,omitzero" yaml:"reuse_settings,omitempty"`
	DownloadSettings *XHTTPDownloadSettings `json:"download_settings,omitzero" yaml:"download_settings,omitempty"`
}
...
type XHTTPReuseSettings struct {
	...
	HKeepAlivePeriod int    `json:"h_keep_alive_period,omitzero" yaml:"h_keep_alive_period,omitempty"`
}

type XHTTPDownloadSettings struct {
	Server        *string             `json:"server,omitzero" yaml:"server,omitempty"`
	...
	Headers       *map[string]string  `json:"headers,omitzero" yaml:"headers,omitempty"`
...
type MultiplexOptions struct {
	...
	MaxConnections int    `json:"max_connections,omitzero" yaml:"max_connections,omitempty"`
	MinStreams     int    `json:"min_streams,omitzero" yaml:"min_streams,omitempty"`
	MaxStreams     int    `json:"max_streams,omitzero" yaml:"max_streams,omitempty"`
	Padding        bool   `json:"padding,omitzero" yaml:"padding,omitempty"`
}
...
type SnellOptions struct {
	...
	Reuse             *bool             `json:"reuse,omitzero" yaml:"reuse,omitempty"`
	ClientFingerprint string            `json:"client_fingerprint,omitempty" yaml:"client_fingerprint,omitempty"`
	ShadowTLS         *ShadowTLSOptions `json:"shadow_tls,omitzero" yaml:"shadow_tls,omitempty"`
}
...
type AnyTLSOptions struct {
	...
	MinIdleSession           int    `json:"min_idle_session,omitzero" yaml:"min_idle_session,omitempty"`
}
...
type TUICOptions struct {
	...
	ZeroRTTHandshake     bool   `json:"zero_rtt_handshake,omitzero" yaml:"zero_rtt_handshake,omitempty"`
	ReduceRTT            bool   `json:"reduce_rtt,omitzero" yaml:"reduce_rtt,omitempty"`
	Heartbeat            string `json:"heartbeat,omitempty" yaml:"heartbeat,omitempty"`
	UDPOverStream        bool   `json:"udp_over_stream,omitzero" yaml:"udp_over_stream,omitempty"`
	UDPOverStreamVersion int    `json:"udp_over_stream_version,omitzero" yaml:"udp_over_stream_version,omitempty"`
}
...
type WireGuardOptions struct {
	...
	MTU                 int             `json:"mtu,omitzero" yaml:"mtu,omitempty"`
	Workers             int             `json:"workers,omitzero" yaml:"workers,omitempty"`
	PersistentKeepalive int             `json:"persistent_keepalive,omitzero" yaml:"persistent_keepalive,omitempty"`
	Reserved            []uint8         `json:"reserved,omitzero" yaml:"reserved,omitempty"`
}
